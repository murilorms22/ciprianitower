        ...
        >
          ...
          <motion.div variants={itemVariants} className="bg-[#1A1A1A] p-8 md:p-10 flex flex-col justify-center radius-mix-2 text-white">
            ...
            <ul className="space-y-3 font-sans text-gray-400 text-sm">
              <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#C4A57A] mr-3 shrink-0" />2 suítes em todas as unidades</li>
          ...
          {/* Bento Item 5: List of Features */}
          <motion.div variants={itemVariants} className="bg-[#F9F9F9] p-8 md:p-10 rounded-3xl border border-gray-100 flex flex-col justify-center">
            ...
            <ul className="space-y-3 font-sans text-gray-600 text-sm">
              <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#C4A57A] mr-3" />Quadra poliesportiva</li>
              <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#C4A57A] mr-3" />2 espaços gourmet</li>
              <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#C4A57A] mr-3" />Game center</li>
              <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#C4A57A] mr-3" />Praça do fogo</li>
              <li className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-[#C4A57A] mr-3" />Espaço pet</li>
            </ul>
          </motion.div>
